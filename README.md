...
**For any problems running this specific bot:** [Discord Project Post](https://discord.com/channels/941552503076569149/941553579993489438)

**For general OpenAI API problems or questions:** [Discord API Discussions](https://discord.com/channels/941552503076569149/941553579993489438)

**For bugs in the template code:** create an Issue

**For feature requests:** this repo is not accepting feature requests, you can discuss potential features in [Discord Project Post](https://discord.com/channels/941552503076569149/941553579993489438)
...
---
# Kyojuro Rengoku Discord Bot

Example Discord bot written in Python that uses the [completions API](https://discord.com/channels/941552503076569149/941553579993489438) to have conversations with the `text-davinci-003` model, and the [moderations API](https://discord.com/channels/941552503076569149/941553579993489438) to filter the messages.
